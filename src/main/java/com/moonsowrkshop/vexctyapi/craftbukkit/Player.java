package com.moonsowrkshop.vexctyapi.craftbukkit;
...
public interface Player extends HumanEntity, Conversable, CommandSender, OfflinePlayer, PluginMessageRecipient {
    ...
    public default void sendTranslated(String msg) {
        if (msg.contains("%%red%%")) {
            msg.replace("%%red%%", "\" + ChatColor.RED + \"");
        } else if (msg.contains("%%green%%")) {
            msg.replace("%%green%%", "\" + ChatColor.GREEN + \"");
        } else if (msg.contains("%%black%%")) {
            msg.replace("%%black%%", "\" + ChatColor.BLACK + \"");
        } else if (msg.contains("%%dg%%")) {
            msg.replace("%%dg%%", "\" + ChatColor.DARK_GREEN + \"");
        } else if (msg.contains("%%dr%%")) {
            msg.replace("%%dr%%", "\" + ChatColor.DARK_RED + \"");
        } else if (msg.contains("%%gold%%")) {
            msg.replace("%%gold%%", "\" + ChatColor.GOLD + \"");
        } else if (msg.contains("%%white%%")) {
            msg.replace("%%white%%", "\" + ChatColor.WHITE + \"");
        } else if (msg.contains("%%yellow%%")) {
            msg.replace("%%yellow%%", "\" + ChatColor.YELLOW + \"");
        } else if (msg.contains("%%magic%%")) {
            msg.replace("%%magic%%", "\" + ChatColor.MAGIC + \"");
        }
    }
    ...
    public class Spigot extends Entity.Spigot
    {
         ...
         * @deprecated Use {@link org.bukkit.entity.Player#getLocale()
         */
        @Deprecated
        public String getLocale()
        {
